...
function GethtmlExt(){
    ...
    return '<tr><td><input type="text" class="ext" placeholder="扩展名" value="'+ext+'"></td><td class="TdSize"><input type="text" class="size" placeholder="大小限制" value="'+size+'"></td><td class="SizeButton">MB</td><td id="RemoveExt" class="RemoveButton">X</td></tr>';
}
